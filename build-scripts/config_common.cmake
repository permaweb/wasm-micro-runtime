...
if (WAMR_BUILD_NAN_CANONICALIZATION EQUAL 1)
  add_definitions (-DWASM_ENABLE_NAN_CANONICALIZATION=1)
  message ("     NaN canonicalization enabled")
  if (WAMR_BUILD_NAN_CANONICALIZATION_SIGN_BIT EQUAL 1)
    add_definitions (-DWASM_NAN_CANONICALIZATION_SIGN_BIT=1)
    message ("     NaN canonicalization sign bit 1 (negative)")
  else ()
    add_definitions (-DWASM_NAN_CANONICALIZATION_SIGN_BIT=0)
    message ("     NaN canonicalization sign bit 0 (positive)")
  endif ()
endif ()